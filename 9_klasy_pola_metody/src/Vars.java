public class Vars {
    ...
    public static void main(String[] args) {
        ...
        Vars v1 = new Vars(); //to także jest zmienna lokalna
        v1.i = 9;
        System.out.println("Wyświetlam zmienną egzemplarza dla v1: " + v1.i);

        Vars v2 = new Vars();
        v2.i = 5;
        System.out.println("Wyświetlam zmienną egzemplarza dla v2: " + v2.i);
